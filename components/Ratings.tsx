    ...
    <div className="px-6 pb-10">
      ...
      <div className="mt-6 space-y-4">
        ...
        <p className="text-sm text-gray-600">
          Muy buena aplicación, funciona perfectamente para confirmar mis operaciones. Mucho más segura que el SMS. La recomiendo totalmente para clientes de Bankinter.
        </p>
